...
variable "eks-managed-nodegroup-name" {
  ...
  type        = string
  default     = "eks-managed-nodegroup-harsh"
}
...
variable "rds_security_group_name" {
  ...
  type        = string
  default     = "rds_security_group_harsh"
}
...
variable "bastion_security_group_name" {
  ...
  type        = string
  default     = "bastion_host_security_group_harsh"
}
